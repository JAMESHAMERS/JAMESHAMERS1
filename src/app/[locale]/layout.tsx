...
// Tints the mobile browser chrome (Safari/Chrome address bar) to match
// `--background` per theme, instead of the browser's default white/black —
// matches "#0a0a0a", the hex nearest `oklch(0.145 0 0)` (dark `--background`).
